...
### Web interface
When done flashing, you can check ESP8266 board's IP address in router. Then access it via a browser. This is screenshoot of the web interface.
![Web interface](img/app.png)
